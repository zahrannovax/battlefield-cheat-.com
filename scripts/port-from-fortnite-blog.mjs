#!/usr/bin/env node
/**
 * Ports the 8 posts from ../battlefield-6-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'battlefield-6-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'battlefield-6 intel'],
...
const file = `/* Auto-generated by scripts/port-from-battlefield-6-blog.mjs — do not edit by hand. */
