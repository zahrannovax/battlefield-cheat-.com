...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/battlefield-6-cheats-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/battlefield-6-cheats-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/battlefield-6-cheats-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/battlefield-6-hero-banner.webp');
