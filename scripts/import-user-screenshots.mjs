...
const USER_SCREENSHOTS = [
	{
		...
		file: 'battlefield-6-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'battlefield-6-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'battlefield-6-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'battlefield-6-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'battlefield-6-esp-radar.webp',
	},
	{
		source:
		...
		file: 'battlefield-6-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'battlefield-6-battle-royale-combat',
	'battlefield-6-extract-fight',
	'battlefield-6-cheats-aimbot',
	'battlefield-6-cheats-cover',
	'battlefield-6-cheats-esp-wallhack',
	'battlefield-6-cheats-hero',
	'battlefield-6-cheats-logo',
	'battlefield-6-cheats-package',
	'battlefield-6-header-art',
	'battlefield-6-loadout-builder',
	'battlefield-6-player-esp',
	'battlefield-6-scav-run-combat',
	'battlefield-6-scav-run-mode',
	'battlefield-6-squad-fight',
	'battlefield-6-verdansk-map',
];

async function removeOldBattlefield 6Images() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'battlefield-6-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `battlefield-6-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'battlefield-6-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'battlefield-6-cheats-logo.png');
...
await removeOldBattlefield 6Images();
