...
const replacements = [
	...
	['published by ${EXT.activision}', 'published by Battlestate Games (${EXT.battlefield-6})'],
	['from ${EXT.activision}', 'from ${EXT.battlefield-6}'],
	['via ${EXT.activision}', 'via ${EXT.battlefield-6}'],
	['belong with ${EXT.activision}', 'belong with Battlestate Games'],
	['${EXT.activision} terms', 'Battlestate Games terms'],
	['${EXT.activision} season updates', '${EXT.battlefield-6} wipe and map updates'],

	['PC & Controllers', 'Windows PC'],
	['PC & Controller Guide', 'Windows PC Guide'],
	['PC and controller cheats', 'Windows PC cheats'],

	// BR / Fortnite lexicon → Battlefield 6
	...
	['ESP, Soft Aim & ', 'ESP, Soft Aim & Radar'],
	['with — learn', '— learn'],
	['REA Javelin out for', 'Reach out for'],
	['an EA Javelin', 'a EA Javelin'],
	['After a Escape', 'After an Escape'],
	['after a Escape', 'after an Escape'],

	// Keyword stuffing / nonsense duplicates
	['battlefield 6 cheats & battlefield 6 cheats', 'battlefield 6 cheats'],
	[
		'covering both battlefield 6 cheats and battlefield 6 cheats search intent',
		'covering both “battlefield 6 cheats” and “escape from battlefield 6 cheats” search intent',
	],
	[
		'also searched as battlefield 6 cheats and battlefield-6 cheat.',
		'built for Escape from Battlefield 6 on Windows PC.',
	],
	[
		'Battlefield 6 cheats vs battlefield 6 cheats — same stack, clear pages',
		'How this Battlefield 6 cheats pillar fits nearby pages',
	],
	[
		'Searchers use battlefield 6 cheats and battlefield 6 cheats interchangeably. This pillar focuses on hacks language; the',
	...
	['best Battlefield 6 cheats guide', 'Battlefield 6 cheats pillar'],
	['best Battlefield 6 cheats checklist', 'Battlefield 6 cheats checklist'],
	['best Battlefield 6 cheats', 'Battlefield 6 cheats'],
	[
		'Prefer softer tracking? Read the <a href="/battlefield-6-soft-aim/">soft aim guide</a>. Want the search term most players use? See <a href="/battlefield-6-aimbot/">aimbot hack</a>.',
		'Prefer softer tracking? Read the <a href="/battlefield-6-soft-aim/">soft aim guide</a>.',
	],
	['Related landings: <a href="/battlefield-6-cheat-download/">cheat download</a>, <a href="/battlefield-6-mod-menu/">mod menu</a>, <a href="/battlefield-6-aimbot/">aimbot hack</a>, <a href="/battlefield-6-esp/">ESP hack</a>.',
		'Related landings: <a href="/battlefield-6-cheat-download/">cheat download</a>, <a href="/battlefield-6-mod-menu/">mod menu</a>, <a href="/battlefield-6-aimbot/">aimbot</a>, <a href="/battlefield-6-esp/">ESP</a>.'],
];
