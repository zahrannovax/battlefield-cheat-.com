...
const KW = {
	...
	cheats: 'battlefield 6 cheats',
	hack: 'battlefield-6 cheat',
	esp: 'battlefield 6 esp',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'battlefield 6 aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Battlefield 6 Cheats', undetected: 'indetectables', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'Contacta our Discord server para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Battlefield 6 Cheats', undetected: 'indétectables', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'Contactez our Discord server pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Battlefield 6 Cheats kaufen', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Battlefield 6 Cheats', undetected: 'indetectáveis', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'Contacte our Discord server para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Battlefield 6 Cheats', undetected: 'indetectable', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'Contatta our Discord server per supporto o richieste legali.',
	},
	nl: {
		buy: 'Battlefield 6 Cheats kopen', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Battlefield 6 Cheats satın al', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'Destek ve yasal sorular için our Discord server.',
	},
	ar: {
		buy: 'اشترِ Battlefield 6 Cheats', undetected: 'غير مكتشف', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Battlefield 6 Cheatsを購入', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'サポート・法務: our Discord server',
	},
	ko: {
		buy: 'Battlefield 6 Cheats 구매', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => '지원 및 법무: our Discord server',
	},
	zh: {
		buy: '购买 Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => '支持与法务：our Discord server',
	},
	hi: {
		buy: 'Battlefield 6 Cheats खरीदें', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'सहायता: our Discord server',
	},
	id: {
		buy: 'Beli Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Battlefield 6 Cheats', undetected: 'undetected', maps: 'Customs, Woods, and Streets of Battlefield 6',
		...
		legal: () => 'our Discord server för support och juridik.',
	},
};
