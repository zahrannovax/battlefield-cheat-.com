...
const PAGE_META_HOME = {
	es: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack y Aimbot', desc: 'Trucos Battlefield 6 indetectables para Battlefield 6 en PC. ESP wallhack, Cloud-DMA y Aimbot con mantenimiento EA Javelin anti-cheat. Entrega digital instantánea.', h1: 'Battlefield 6 Cheats — ESP, Wallhack y Aimbot indetectables', intro: 'Paquete undetected para Battlefield 6 en Windows PC: ESP wallhack, radar y Aimbot con mantenimiento EA Javelin anti-cheat tras cada parche.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galería Battlefield 6 Cheats — ESP, Aimbot y wallhack', cta2: 'Ver funciones', h2a: 'Por qué eligen Battlefield 6 Cheats en 2026', h2b: 'ESP wallhack, radar y Aimbot en una licencia', topicA: 'Ideal para leer escuadrones enemigos en Conquest y Rush.', topicB: 'Una licencia en lugar de herramientas separadas.' },
	fr: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack et Aimbot', desc: 'Triches Battlefield 6 indétectables pour Battlefield 6 sur PC. ESP wallhack, Cloud-DMA et Aimbot avec maintenance EA Javelin anti-cheat. Livraison numérique instantanée.', h1: 'Battlefield 6 Cheats — ESP, Wallhack et Aimbot indétectables', intro: 'Pack undetected pour Battlefield 6 sur PC Windows : ESP wallhack, radar et Aimbot avec maintenance EA Javelin anti-cheat après chaque patch.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galerie Battlefield 6 Cheats — ESP, Aimbot et wallhack', cta2: 'Voir les fonctions', h2a: 'Pourquoi choisir Battlefield 6 Cheats en 2026', h2b: 'ESP wallhack, radar et Aimbot en une licence', topicA: 'Parfait pour lire les escouades ennemies en Conquest et Rush.', topicB: 'Une licence au lieu d\'outils séparés.' },
	de: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Battlefield 6 Cheats für Battlefield 6 auf PC. ESP Wallhack, Radar Hack und Aimbot mit EA Javelin anti-cheat-Wartung. Sofortige digitale Lieferung.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC Paket für Battlefield 6: ESP Wallhack, Radar und Aimbot mit EA Javelin anti-cheat-Wartung nach jedem Patch.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Battlefield 6 Cheats Galerie — ESP, Aimbot und Wallhack', cta2: 'Features ansehen', h2a: 'Warum Battlefield 6 Cheats 2026 führt', h2b: 'ESP Wallhack, Radar und Aimbot in einer Lizenz', topicA: 'Ideal um feindliche Squads in Conquest und Rush zu lesen.', topicB: 'Eine Lizenz statt separater Tools.' },
	pt: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats Battlefield 6 indetectáveis para Battlefield 6 no PC. ESP wallhack, Cloud-DMA e Aimbot com manutenção EA Javelin anti-cheat. Entrega digital instantánea.', h1: 'Battlefield 6 Cheats — ESP, Wallhack e Aimbot indetectáveis', intro: 'Pacote undetected para Battlefield 6 no Windows PC: ESP wallhack, radar e Aimbot com manutenção EA Javelin anti-cheat após cada patch.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galeria Battlefield 6 Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher Battlefield 6 Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler esquadrões inimigos em Conquest e Rush.', topicB: 'Uma licença em vez de ferramentas separadas.' },
	it: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheat Battlefield 6 indetectable per Battlefield 6 su PC. ESP wallhack, Cloud-DMA e Aimbot con manutenzione EA Javelin anti-cheat. Consegna digitale istantanea.', h1: 'Battlefield 6 Cheats — ESP, Wallhack e Aimbot indetectable', intro: 'Pacchetto undetected per Battlefield 6 su PC Windows: ESP wallhack, radar e Aimbot con manutenzione EA Javelin anti-cheat dopo ogni patch.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galleria Battlefield 6 Cheats — ESP, Aimbot e wallhack', cta2: 'Vedi funzioni', h2a: 'Perché scegliere Battlefield 6 Cheats nel 2026', h2b: 'ESP wallhack, radar e Aimbot in una licenza', topicA: 'Ideale per leggere squadre nemiche in Conquest e Rush.', topicB: 'Una licenza invece di tool separati.' },
	nl: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Battlefield 6 cheats voor Battlefield 6 op PC. ESP wallhack, Cloud-DMA en Aimbot met EA Javelin anti-cheat-onderhoud. Directe digitale levering.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC pakket voor Battlefield 6: ESP wallhack, radar en Aimbot met EA Javelin anti-cheat-onderhoud na elke patch.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Battlefield 6 Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Battlefield 6 Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in Conquest en Rush.', topicB: 'Eén licentie in plaats van losse tools.' },
	pl: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack i Aimbot', desc: 'Undetected cheaty Battlefield 6 dla Battlefield 6 na PC. ESP wallhack, Cloud-DMA i Aimbot z konserwacją EA Javelin anti-cheat. Natychmiastowa dostawa cyfrowa.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack i Aimbot', intro: 'Pakiet undetected dla Battlefield 6 na Windows PC: ESP wallhack, radar i Aimbot z konserwacją EA Javelin anti-cheat po każdym patchu.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galeria Battlefield 6 Cheats — ESP, Aimbot i wallhack', cta2: 'Zobacz funkcje', h2a: 'Dlaczego Battlefield 6 Cheats w 2026', h2b: 'ESP wallhack, radar i Aimbot w jednej licencji', topicA: 'Idealny do czytania wrogich squadów w Conquest i Rush.', topicB: 'Jedna licencja zamiast osobnych narzędzi.' },
	ru: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack и Aimbot', desc: 'Undetected читы Battlefield 6 для Battlefield 6 на PC. ESP wallhack, Cloud-DMA и Aimbot с обслуживанием EA Javelin anti-cheat. Мгновенная цифровая доставка.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack и Aimbot', intro: 'Undetected пакет для Battlefield 6 на Windows PC: ESP wallhack, radar и Aimbot с обслуживанием EA Javelin anti-cheat после патчей.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Галерея Battlefield 6 Cheats — ESP, Aimbot и wallhack', cta2: 'Смотреть функции', h2a: 'Почему выбирают Battlefield 6 Cheats в 2026', h2b: 'ESP wallhack, radar и Aimbot в одной лицензии', topicA: 'Идеально для чтения вражеских отрядов в Conquest и Rush.', topicB: 'Одна лицензия вместо отдельных инструментов.' },
	tr: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'Battlefield 6 için undetected hileler. ESP wallhack, Cloud-DMA ve Aimbot — EA Javelin anti-cheat bakımı. Anında dijital teslimat.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack ve Aimbot', intro: 'Battlefield 6 Windows PC undetected paketi: ESP wallhack, radar ve Aimbot — EA Javelin anti-cheat bakımı dahil.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Battlefield 6 Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden Battlefield 6 Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'Conquest ve Rush\'da düşman squad okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'Battlefield 6 Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش Battlefield 6 undetected لـ Battlefield 6 على PC. ESP wallhack ورadar hack وAimbot مع صيانة EA Javelin anti-cheat. تسليم رقمي فوري.', h1: 'Battlefield 6 Cheats — ESP وWallhack وAimbot غير مكتشف', intro: 'حزمة undetected لـ Battlefield 6 على Windows PC: ESP wallhack ورadar وAimbot مع صيانة EA Javelin anti-cheat.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'معرض Battlefield 6 Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Battlefield 6 Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في Conquest وRush.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'Battlefield 6 Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'Battlefield 6向けundetectedチート。ESP wallhack、Cloud-DMA、Aimbot、EA Javelin anti-cheatメンテナンス。即時デジタル配信。', h1: 'Battlefield 6 Cheats — Undetected ESP・Wallhack・Aimbot', intro: 'Battlefield 6 Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、EA Javelin anti-cheatメンテナンス付き。', imageAlt: 'Battlefield 6 cheats hero ESP aimbot wallhack', gallery: 'Battlefield 6 Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にBattlefield 6 Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'ConquestとRushで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'Battlefield 6 undetected 치트. ESP wallhack, Cloud-DMA, Aimbot, EA Javelin anti-cheat 유지보수. 즉시 디지털 배송.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack, Aimbot', intro: 'Battlefield 6 Windows PC undetected 패키지: ESP wallhack, radar, Aimbot, EA Javelin anti-cheat 유지보수 포함.', imageAlt: 'Battlefield 6 cheats hero ESP aimbot wallhack', gallery: 'Battlefield 6 Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 Battlefield 6 Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'Conquest 및 Rush에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'Battlefield 6 Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Battlefield 6 undetected作弊。ESP wallhack、Cloud-DMA、Aimbot、EA Javelin anti-cheat维护。即时数字交付。', h1: 'Battlefield 6 Cheats — Undetected ESP、Wallhack、Aimbot', intro: 'Battlefield 6 Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含EA Javelin anti-cheat维护。', imageAlt: 'Battlefield 6 cheats hero ESP aimbot wallhack', gallery: 'Battlefield 6 Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Battlefield 6 Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在Conquest和Rush中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	hi: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack और Aimbot', desc: 'Battlefield 6 undetected cheats. ESP wallhack, Cloud-DMA, Aimbot, EA Javelin maintenance. Instant digital delivery.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack और Aimbot', intro: 'Battlefield 6 Windows PC undetected पैकेज: ESP wallhack, radar, Aimbot, EA Javelin maintenance सहित.', imageAlt: 'Battlefield 6 cheats hero ESP aimbot wallhack', gallery: 'Battlefield 6 Cheats gallery — ESP, Aimbot, wallhack', cta2: 'फ़ीचर्स देखें', h2a: '2026 में Battlefield 6 Cheats क्यों', h2b: 'ESP wallhack, radar, Aimbot एक लाइसेंस में', topicA: 'Conquest और Rush में दुश्मन squad पढ़ने के लिए आदर्श.', topicB: 'अलग टूल्स के बजाय एक लाइसेंस.' },
	id: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Battlefield 6 undetected untuk Battlefield 6 di PC. ESP wallhack, Cloud-DMA, Aimbot, pemeliharaan EA Javelin anti-cheat. Pengiriman digital instan.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Paket undetected Battlefield 6 di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan EA Javelin anti-cheat.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galeri Battlefield 6 Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Battlefield 6 Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di Conquest dan Rush.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	th: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack และ Aimbot', desc: 'Cheat Battlefield 6 undetected สำหรับ Battlefield 6 บน PC. ESP wallhack, Cloud-DMA, Aimbot, EA Javelin maintenance. จัดส่งดิจิทัลทันที.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack และ Aimbot', intro: 'แพ็ก undetected สำหรับ Battlefield 6 บน Windows PC: ESP wallhack, radar, Aimbot พร้อม EA Javelin maintenance', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'แกลเลอรี Battlefield 6 Cheats — ESP, Aimbot, wallhack', cta2: 'ดูฟีเจอร์', h2a: 'ทำไมเลือก Battlefield 6 Cheats ปี 2026', h2b: 'ESP wallhack, radar, Aimbot ในใบอนุญาตเดียว', topicA: 'เหมาะสำหรับอ่าน squad ศัตรูใน Conquest และ Rush', topicB: 'ใบอนุญาตเดียวแทนเครื่องมือแยก' },
	vi: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Battlefield 6 undetected cho Battlefield 6 trên PC. ESP wallhack, Cloud-DMA, Aimbot, bảo trì EA Javelin anti-cheat. Giao hàng kỹ thuật số tức thì.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Gói undetected Battlefield 6 trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì EA Javelin anti-cheat.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Thư viện Battlefield 6 Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Battlefield 6 Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong Conquest và Rush.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
	uk: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack і Aimbot', desc: 'Undetected чіти Battlefield 6 для Battlefield 6 на PC. ESP wallhack, Cloud-DMA, Aimbot, обслуговування EA Javelin anti-cheat. Мгновенная цифровая доставка.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack і Aimbot', intro: 'Undetected пакет для Battlefield 6 на Windows PC: ESP wallhack, radar, Aimbot з обслуговуванням EA Javelin anti-cheat.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Галерея Battlefield 6 Cheats — ESP, Aimbot, wallhack', cta2: 'Дивитися функції', h2a: 'Чому Battlefield 6 Cheats у 2026', h2b: 'ESP wallhack, radar і Aimbot в одній ліцензії', topicA: 'Ідеально для читання ворожих загонів у Conquest і Rush.', topicB: 'Одна ліцензія замість окремих інструментів.' },
	cs: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack a Aimbot', desc: 'Undetected Battlefield 6 cheaty pro Battlefield 6 na PC. ESP wallhack, Cloud-DMA, Aimbot, údržba EA Javelin anti-cheat. Okamžité digitální doručení.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack a Aimbot', intro: 'Undetected balíček pro Battlefield 6 na Windows PC: ESP wallhack, radar, Aimbot s údržbou EA Javelin anti-cheat.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galerie Battlefield 6 Cheats — ESP, Aimbot, wallhack', cta2: 'Zobrazit funkce', h2a: 'Proč Battlefield 6 Cheats v roce 2026', h2b: 'ESP wallhack, radar a Aimbot v jedné licenci', topicA: 'Ideální pro čtení nepřátelských squadů v Conquest a Rush.', topicB: 'Jedna licence místo samostatných nástrojů.' },
	ro: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack și Aimbot', desc: 'Cheats Battlefield 6 undetected pentru Battlefield 6 pe PC. ESP wallhack, Cloud-DMA, Aimbot, mentenanță EA Javelin anti-cheat. Livrare digitală instantă.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack și Aimbot', intro: 'Pachet undetected Battlefield 6 pe Windows PC: ESP wallhack, radar, Aimbot cu mentenanță EA Javelin anti-cheat.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Galerie Battlefield 6 Cheats — ESP, Aimbot, wallhack', cta2: 'Vezi funcții', h2a: 'De ce Battlefield 6 Cheats în 2026', h2b: 'ESP wallhack, radar și Aimbot într-o licență', topicA: 'Ideal pentru citirea squad-urilor inamice în Conquest și Rush.', topicB: 'O licență în loc de instrumente separate.' },
	sv: { title: 'Battlefield 6 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Battlefield 6 cheats för Battlefield 6 på PC. ESP wallhack, Cloud-DMA, Aimbot, EA Javelin anti-cheat-underhåll. Omedelbar digital leverans.', h1: 'Battlefield 6 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected paket för Battlefield 6 på Windows PC: ESP wallhack, radar, Aimbot med EA Javelin anti-cheat-underhåll.', imageAlt: 'Battlefield 6 ESP player tags hack', gallery: 'Battlefield 6 Cheats galleri — ESP, Aimbot, wallhack', cta2: 'Se funktioner', h2a: 'Varför Battlefield 6 Cheats 2026', h2b: 'ESP wallhack, radar och Aimbot i en licens', topicA: 'Ideal för att läsa fiendesquads i Conquest och Rush.', topicB: 'En licens istället för separata verktyg.' },
};
...
const PAGE_META_TAILS = {
	'bf6-esp': { suffix: 'Player Boxes & Wallhack', focus: 'player boxes, skeleton, and wallhack overlays', altKeyword: 'ESP wallhack overlay' },
	'bf6-aimbot': { suffix: 'Aimbot Controls', focus: 'aimbot FOV, Aim Lock, and Aim Priority', altKeyword: 'aimbot combat' },
	features: { suffix: 'Full Feature List', focus: 'ESP, aimbot, Cloud-DMA controls', altKeyword: 'cheats package ESP aimbot' },
	...
	faq: { suffix: 'Common Answers', focus: 'ESP, aimbot, delivery, and EA Javelin questions', altKeyword: 'FAQ ESP aimbot' },
	...
	wallhack: { suffix: 'ESP Visibility', focus: 'wallhack ESP for players, vehicles, and distance', altKeyword: 'wallhack ESP visibility' },
	radar: { suffix: 'Cloud-DMA Option', focus: 'Cloud-DMA hardware option for Battlefield 6', altKeyword: 'Cloud-DMA overlay' },
	...
	'soft-aim': { suffix: 'Aimbot Settings', focus: 'aimbot smoothness and FOV for Windows PC', altKeyword: 'aimbot settings' },
	...
	'aimbot-hack': { suffix: 'Aim Assist', focus: 'undetected Aimbot hack assist for Battlefield 6', altKeyword: 'aimbot hack combat' },
	'esp-hack': { suffix: 'Boxes & Vehicles', focus: 'ESP hack boxes, vehicles, and distance', altKeyword: 'ESP hack wallhack' },
...
const TOPIC_NAMES = {
	...
	'soft-aim': { en: 'Battlefield 6 Soft Aim', es: 'Aimbot Battlefield 6', fr: 'Aimbot Battlefield 6', de: 'Battlefield 6 Soft Aim', pt: 'Aimbot Battlefield 6', it: 'Aimbot Battlefield 6', nl: 'Battlefield 6 Soft Aim', pl: 'Aimbot Battlefield 6', ru: 'Aimbot Battlefield 6', tr: 'Battlefield 6 Soft Aim', ar: 'Aimbot Battlefield 6', ja: 'Battlefield 6 Soft Aim', ko: 'Battlefield 6 Soft Aim', zh: 'Battlefield 6 Soft Aim', hi: 'Battlefield 6 Soft Aim', id: 'Aimbot Battlefield 6', th: 'Battlefield 6 Soft Aim', vi: 'Aimbot Battlefield 6', uk: 'Aimbot Battlefield 6', cs: 'Battlefield 6 Soft Aim', ro: 'Aimbot Battlefield 6', sv: 'Battlefield 6 Soft Aim' },
	...
	return {
		...
		sections: [
			section(
				...
				p.s1('Contact messages, order references, and basic site security data.'),
				kind === 'privacy' ? 'Payment details are processed by checkout — not stored on battlefieldcheat.com.' : p.s2(),
			),
			section(
				...
				kind === 'terms' ? 'Using cheats may violate EA terms — you assume all ban risk.' : p.s3(),
			),
			section(
