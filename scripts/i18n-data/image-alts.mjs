...
export const DESCRIPTIVE_IMAGE_ALTS = {
	...
	aimbotCombat: 'Aimbot overlay during a Battlefield 6 match',
	...
	cheatsPackage: 'Cloud-DMA overlay option for Battlefield 6',
	...
	battleRoyaleIsland: 'ESP markers for vehicles and objectives in Battlefield 6',
};
...
export const PAGE_IMAGE_ALTS = {
	...
	'bf6-aimbot': 'Battlefield 6 aimbot controls on Windows PC',
	features: 'Battlefield 6 Cheats features — ESP, aimbot, and Cloud-DMA screenshots',
	...
	radar: 'Battlefield 6 Cloud-DMA option overview',
	...
	hacks: 'Battlefield 6 Cheats product page — ESP, aimbot, and Cloud-DMA',
	...
	'soft-aim': 'Battlefield 6 aimbot FOV and smoothness settings',
	...
	'esp-hack': 'Battlefield 6 ESP hack boxes and vehicle markers',
