...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Battlefield 6', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'bf6-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes with {primaryKeyword}' },
	'bf6-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and aim lock controls in {primaryKeyword}' },
	features: { title: '{primaryKeyword} features', caption: 'AWS, Cloud-DMA, ESP, and aimbot included with {primaryKeyword}' },
	...
	radar: { title: '{primaryKeyword} DMA', caption: 'Cloud-DMA option for {primaryKeyword}' },
	javelin: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after an {antiCheat} update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Battlefield 6 on PC' },
	hacks: { title: '{primaryKeyword}', caption: '{primaryKeyword} AWS, Cloud-DMA, ESP, and aimbot package' },
	...
	'soft-aim': { title: '{primaryKeyword} soft aim', caption: 'Aim lock settings in {primaryKeyword}' },
