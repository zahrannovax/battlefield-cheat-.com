...
const CANONICAL_ORIGIN = 'https://battlefieldcheat.com';
const APEX_HOST = 'battlefieldcheat.com';
const WWW_HOST = 'www.battlefieldcheat.com';

/** Legacy domains → canonical apex (301). */
const LEGACY_HOSTS = new Set([
	'battlefield-cheat.com',
	'www.battlefield-cheat.com',
	'fortnitehack.net',
...
const PATH_REDIRECTS = {
	...
	'/escape-from-battlefield-6-cheats': '/battlefield-6-cheats/',
	'/escape-from-battlefield-6-cheats/': '/battlefield-6-cheats/',
	// Cannibalization → canonical landings (money URL = /battlefield-6-cheats/)
	...
	'/best-battlefield-6-cheats/': '/battlefield-6-cheats/',
	'/battlefield-6-cheats-2026': '/battlefield-6-cheats/',
	'/battlefield-6-cheats-2026/': '/battlefield-6-cheats/',
	'/undetected-battlefield-6-cheats': '/battlefield-6-cheats/',
	'/undetected-battlefield-6-cheats/': '/battlefield-6-cheats/',
	'/battlefield-6-mod-menu': '/battlefield-6-cheats/',
	'/battlefield-6-mod-menu/': '/battlefield-6-cheats/',
	'/battlefield-6-unlock-all': '/battlefield-6-cheats/',
	'/battlefield-6-unlock-all/': '/battlefield-6-cheats/',
	'/battlefield-6-soft-aim': '/battlefield-6-aimbot/',
	'/battlefield-6-soft-aim/': '/battlefield-6-aimbot/',
	'/battlefield-6-wallhack': '/battlefield-6-esp/',
	'/battlefield-6-wallhack/': '/battlefield-6-esp/',
	'/battlefield-6-cheat-download': '/setup/',
	'/battlefield-6-cheat-download/': '/setup/',
	...
	'/warzone-hacks/': '/battlefield-6-cheats/',
	'/warzone-esp': '/battlefield-6-esp/',
	'/warzone-esp/': '/battlefield-6-esp/',
	'/warzone-aimbot': '/battlefield-6-aimbot/',
	'/warzone-aimbot/': '/battlefield-6-aimbot/',
	'/ricochet-bypass': '/updates/',
	'/ricochet-bypass/': '/updates/',
	'/fortnite-aimbot': '/battlefield-6-aimbot/',
	'/fortnite-aimbot/': '/battlefield-6-aimbot/',
	'/fortnite-esp': '/battlefield-6-esp/',
	'/fortnite-esp/': '/battlefield-6-esp/',
	'/fortnite-hacks': '/battlefield-6-cheats/',
	'/fortnite-hacks/': '/battlefield-6-cheats/',
	'/eac-bypass': '/updates/',
	'/eac-bypass/': '/updates/',
	'/eac-bypass-fortnite': '/updates/',
	'/eac-bypass-fortnite/': '/updates/',
	'/blog/patch-notes-buffs-nerfs-vaults': '/blog/battlefield-6-patch-notes-guide/',
	'/blog/patch-notes-buffs-nerfs-vaults/': '/blog/battlefield-6-patch-notes-guide/',
	'/blog/chapter-7-season-3-skin-leaks-vbucks': '/blog/battlefield-6-skin-leaks-guide/',
	'/blog/chapter-7-season-3-skin-leaks-vbucks/': '/blog/battlefield-6-skin-leaks-guide/',
	'/blog/hammer-ar-s-tier-data-analysis': '/blog/battlefield-6-weapon-tier-list/',
	'/blog/hammer-ar-s-tier-data-analysis/': '/blog/battlefield-6-weapon-tier-list/',
	'/blog/zero-build-meta-broken-aggressive-strategies': '/blog/battlefield-6-rush-aggressive-strategies/',
	'/blog/zero-build-meta-broken-aggressive-strategies/': '/blog/battlefield-6-rush-aggressive-strategies/',
	'/blog/fncs-meta-watch-tournament-drops': '/blog/battlefield-6-tournament-meta-guide/',
	'/blog/fncs-meta-watch-tournament-drops/': '/blog/battlefield-6-tournament-meta-guide/',
	'/blog/secret-loot-routes-full-gold': '/blog/battlefield-6-loot-routes-guide/',
	'/blog/secret-loot-routes-full-gold/': '/blog/battlefield-6-loot-routes-guide/',
	'/blog/bugha-settings-pro-setup': '/blog/battlefield-6-pro-settings-guide/',
	'/blog/bugha-settings-pro-setup/': '/blog/battlefield-6-pro-settings-guide/',
	'/blog/creative-warmup-maps-pros-use': '/blog/battlefield-6-warmup-maps-ranked/',
	'/blog/creative-warmup-maps-pros-use/': '/blog/battlefield-6-warmup-maps-ranked/',
	'/reviews/battlefield-6-esp-zero-build-review-buildsr4k': '/reviews/battlefield-6-esp-scav-run-review-buildsr4k/',
	'/reviews/battlefield-6-esp-zero-build-review-buildsr4k/': '/reviews/battlefield-6-esp-scav-run-review-buildsr4k/',
	'/reviews/battlefield-6-radar-hack-review-vanlifefn': '/reviews/battlefield-6-radar-hack-review-bf6player/',
	'/reviews/battlefield-6-radar-hack-review-vanlifefn/': '/reviews/battlefield-6-radar-hack-review-bf6player/',
	'/reviews/battlefield-6-radar-hack-review-vanlifewz': '/reviews/battlefield-6-radar-hack-review-bf6player/',
	'/reviews/battlefield-6-radar-hack-review-vanlifewz/': '/reviews/battlefield-6-radar-hack-review-bf6player/',
	'/reviews/battlefield-6-soft-aim-review-ctrl-player99': '/reviews/battlefield-6-soft-aim-review-ctrl-player99/',
	'/reviews/battlefield-6-soft-aim-review-ctrl-player99/': '/reviews/battlefield-6-soft-aim-review-ctrl-player99/',
};
